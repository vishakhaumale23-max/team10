...
def load_reminders():
    if os.path.exists(REMINDER_FILE):
        ...
        sample = {
            today: [
                {"time": "16:55", "text": "Take Paracetamol", "medication": "Paracetamol", "risk": medication_risks["Paracetamol"]},
                {"time": "16:56", "text": "Take Cetirizine", "medication": "Cetirizine", "risk": medication_risks["Cetirizine"]}
            ]
        }
...
reminder_entry.insert(0, "Take your medication")  # Sample input
...
med_dropdown.set("Paracetamol")  # Sample input
...
risk_dropdown.set(medication_risks["Paracetamol"])  # Sample input
