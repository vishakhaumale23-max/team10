...
medication_risks = {
    ...
    "Ibuprofen": "May cause stomach ulcers or kidney issues.",
    "Metformin": "May lead to lactic acidosis in rare cases.",
    "Atorvastatin": "May cause muscle pain or liver enzyme elevation.",
    "Omeprazole": "May cause headache or nutrient malabsorption.",
    "Amoxicillin": "May cause allergic reactions or diarrhea.",
    "Hydrochlorothiazide": "May cause dehydration or electrolyte imbalance.",
    "Clopidogrel": "May increase bleeding risk.",
    "Vitamin D": "Excess intake may lead to calcium buildup in the blood.",
    "Calcium Carbonate": "Too much can cause kidney stones or constipation.",
    "Zinc Sulfate": "May cause nausea or metallic taste.",
    "Iron (Ferrous Sulfate)": "May cause constipation or dark stools.",
    "Probiotic Capsules": "May cause bloating or gas.",
...
def load_reminders():
    if os.path.exists(REMINDER_FILE):
        ...
        sample = {
            today: [
                {"time": "17:10", "text": "Take Paracetamol", "medication": "Paracetamol", "risk": medication_risks["Paracetamol"]},
                {"time": "17:11", "text": "Take Cetirizine", "medication": "Cetirizine", "risk": medication_risks["Cetirizine"]}
            ]
        }
...
risk_dropdown.set(medication_risks["Paracetamol"])
